    ...
    if (administrativeData.length === 0) {
      try {
        const response = await fetch(
          "https://corsproxy.io/?https://raw.githubusercontent.com/itscharukadeshan/map_srilanka_data/refs/heads/main/v1/administrative/misc/administrative_norm_compact.json"
        );
        if (!response.ok) {
